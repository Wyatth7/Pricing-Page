...
export const BottomSvg = (props) => {
  return (
    <BOTTOM_SVG xmlns="http://www.w3.org/2000/svg" width="353" height="304">
...
export const TopSvg = (props) => {
  return (
    <TOP_SVG xmlns="http://www.w3.org/2000/svg" width="375" height="658">
      <g fill="none" fillRule="evenodd" stroke="#D0D5F6" strokeWidth="2">
